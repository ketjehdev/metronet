      ...
      <CardContent>
        ...
        {price && (
          <div className="mb-4">
            ...
            <span className="text-muted-foreground">{price != "Pesan Sekarang" ? "/bulan" : ""}</span>
          </div>
        )}
        <Button
            variant="outline"
            ...
            onClick={() => {
            let priceTxt = "";
            if (title !== "Business Enterprise")  
              priceTxt = `(${price})`;
            
            const message = `Halo, saya tertarik dengan paket ${title} ${priceTxt}. Saya ingin diskusi lebih lanjut.`;
