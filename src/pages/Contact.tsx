              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-4 bg-gradient-card rounded-lg border border-border hover:border-primary transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Jalan Antariksa No 80, Medan Polonia - Kota Medan - Sumatera Utara
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-gradient-card rounded-lg border border-border hover:border-primary transition-all duration-300">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:info@metronet.biz.id"
                      className="text-muted-foreground text-sm hover:text-primary transition-colors block"
                    >
                      info@metronet.biz.id
                    </a>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              {
                city: "Medan",
                address: "Jalan Antariksa No 80, Medan Polonia - Kota Medan - Sumatera Utara",
                phone: "+62 857‑7789‑0892",
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="aspect-video rounded-xl overflow-hidden border-2 border-border shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d31626.288005548788!2d110.4150528!3d-7.7594624!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30313011096355df%3A0xa258bb817e04dca8!2sJl.%20Antariksa%20No.80%2C%20Sari%20Rejo%2C%20Kec.%20Medan%20Polonia%2C%20Kota%20Medan%2C%20Sumatera%20Utara%2020158!5e0!3m2!1sen!2sid!4v1759868007805!5m2!1sen!2sid"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            {[
              {
                ...
                answer: "Anda bisa mendaftar melalui website, telepon ke +62 812-3456-7890, atau datang langsung ke kantor cabang terdekat. Tim kami akan membantu proses pendaftaran Anda.",
              },
              {
              ...
              },
              {
                ...
                answer: "Hubungi customer service kami 24/7 melalui telepon +62 812-3456-7890. Tim teknis kami akan segera membantu Anda.",
              },
              {
